        ...
        for UC in UC_TREATMENTS:
            ...
            for T_p in line_limit_scaling:
                ...
                for BA_hurd in BA_hurdle_scaling:
                    ...
                    fn = '/Simulation_folders_' + scenario + '/Exp' + str(y) + '_' + str(NN) + UC + '_' + str(T_p) + '_' + str(BA_hurd)
        
                    path=str(Path.cwd()) + str(Path(fn))
                    ...
                    fn = '../DP output/' + scenario + '/' + scenario + '/' + scenario + '/nodal_hydro_' + str(y) + '_new.csv'
                    df_H = pd.read_csv(fn,header=0)
                    df_H.to_csv('nodal_hydro.csv',index=None)
