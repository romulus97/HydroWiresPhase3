...
####### Hourly timeseries (load, hydro, solar, wind, reserve)
    ...
    for z in h_gens:
        ...
        # for h in range(0,240):
            f.write(z + '_HYDRO' + '\t' + str(h+1) + '\t' + str(df_hydro_MAX.loc[0,z]*.14) + '\n')
    f.write(';\n\n')
    ...
    for z in h_gens:
        ...
        # for h in range(0,240):
            f.write(z + '_HYDRO' + '\t' + str(h+1) + '\t' + str(df_hydro_MIN.loc[0,z]*.14) + '\n')
    f.write(';\n\n')
    ...
    for z in h_gens:
        for h in range(0,len(df_hydro_MAX)): 
        # for h in range(0,240):
            f.write(z + '_HYDRO' + '\t' + str(h+1) + '\t' + str(df_hydro_TOTAL.loc[0,z]*.14) + '\n')
    f.write(';\n\n')
...
####### Daily fuel prices
    ...
    for z in all_thermals:
        for d in range(0,int(SimDays)): 
            f.write(z + '\t' + str(d+1) + '\t' + str(df_fuel.loc[0,z]) + '\n')
    f.write(';\n\n')
